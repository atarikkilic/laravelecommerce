                    ...
                    <x-jet-validation-errors class="mb-4" />
                        ...
                        @csrf
                            <fieldset class="wrap-title">
                                <h3 class="form-title">Hesaba Giriş</h3>										
                            </fieldset>
                            <fieldset class="wrap-input">
                                <label for="frm-login-uname">Email Adresi:</label>
                                <input type="email" id="frm-login-uname" name="email" placeholder="Email adresinizi girin":value="old('email')" required autofocus>
                            </fieldset>
                            <fieldset class="wrap-input">
