...
<div class="container">
    ...
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><span>Sepetim</span></li>
        </ul>
    </div>
    <div class=" main-content-area">
        ...
        <div class="alert alert-success">
            <strong>Success</strong> {{Session::get('succes_message')}}
        </div>        
        @endif
        @if(Cart::count() > 0)
        ...
        <div class="summary">
            <div class="order-summary">
                ...
                <p class="summary-info"><span class="title">Toplam</span><b class="index">{{Cart::subtotal()}}₺</b></p>
                <p class="summary-info"><span class="title">Vergi</span><b class="index">{{Cart::tax()}}₺</b></p>
                <p class="summary-info"><span class="title">Kargo Ücreti</span><b class="index">Ücretsiz</b></p>
                <p class="summary-info total-info "><span class="title">Toplam</span><b class="index">{{Cart::total()}}₺</b></p>
            </div>
            <div class="checkout-info">
                <label class="checkbox-field">
                    <input class="frm-input " name="have-code" id="have-code" value="" type="checkbox"><span>İndirim kodu</span>
                </label>
                <a class="btn btn-checkout" href="checkout.html">Ödeme</a>
                <a class="link-to-shop" href="shop.html">Alışverişe Devam Et<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
            </div>
            <div class="update-clear">
                <a class="btn btn-clear" href="#" wire:click.prevent="destroyAll()">Sepeti Temizle</a>
                <a class="btn btn-update" href="#">Ürün Ekle/Çıkar</a>
            </div>
        </div>
