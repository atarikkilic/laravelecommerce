	...
	<main id="main">
		<div class="container">
				...
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					<div class="item-slide">
						...
						<div class="slide-info slide-1">
							<h2 class="f-title">Çocuklar İçin Akıllı <b>Saatler</b></h2>
							<span class="subtitle">Herkes için akıllı saat.</span>
							<p class="sale-info">Fiyat: <span class="price">200₺</span></p>
							<a href="#" class="btn-link">Satın Al</a>
						</div>
					</div>
					<div class="item-slide">
						<img src="{{ asset('assets/images/main-slider-1-2.jpg') }}" alt="" class="img-slide">
						<div class="slide-info slide-2">
							<h2 class="f-title">Ekstra %25 İndirim</h2>
							<span class="f-subtitle">Online Ödemelerde</span>
							<p class="discount-code">Kodu Kullanın: #ERU123</p>
							<h4 class="s-title">Ücretsiz</h4>
							<p class="s-subtitle">Elbise Askısı</p>
						</div>
					</div>
					<div class="item-slide">
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				<h3 class="title-box">İndirimdeki Ürünler</h3>
					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							...
							<div class="group-flash">
								<span class="flash-item sale-label">stokta</span>
							</div>
							<div class="wrap-btn">
								<a href="#" class="function-link">hızlı inceleme</a>
							</div>
						</div>
						<div class="product-info">
							<a href="#" class="product-name"><span>Lorem ipsum dolor</span></a>
